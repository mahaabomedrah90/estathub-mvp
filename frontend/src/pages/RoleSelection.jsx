    ...
    <PageWrapper>
      ...
      <div className="max-w-7xl mx-auto px-6 py-20">
        ...
        >
          ...
          >
            {/* Icon */}
            <IconBox size="2xl" variant="default" className="mx-auto mb-6 group-hover:bg-brand-accent transition-colors duration-300">
            ...
            <div>
              ...
              <BodyText className="text-text-muted mb-6">
              ...
              <div className="space-y-3 text-sm text-text-body">
                <div className="flex items-center justify-center gap-2">
                  ...
                  <MutedText className="font-normal">
        ...
        >
          ...
          >
            {/* Icon */}
            <IconBox size="2xl" variant="vision" className="mx-auto mb-6 group-hover:bg-vision-purple transition-colors duration-300">
            ...
            <div>
              ...
              <div className="space-y-3 text-sm text-text-body">
                <div className="flex items-center justify-center gap-2">
                  <div className="w-2 h-2 bg-vision-purple rounded-full"></div>
                  <MutedText className="font-normal">
