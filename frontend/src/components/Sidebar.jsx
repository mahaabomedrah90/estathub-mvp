...
export default function Sidebar({ role, isOpen, onClose }) {
  const menuItems = roleMenus[role] || roleMenus.investor
        ...
        <div className="flex flex-col h-full">
          ...
          <div className={`p-6 bg-gradient-to-r ${theme.gradient} relative`}>
            ...
            <button
              ...
              className="absolute -right-3 top-1/2 -translate-y-1/2 w-6 h-6 bg-white rounded-full shadow-lg flex items-center justify-center hover:bg-gray-100 transition-colors"
