...
export const AuditAction = {
  ...
  PROPERTY_LEAD_OWNER_SUPPLEMENTED: 'PROPERTY_LEAD_OWNER_SUPPLEMENTED',
  PROPERTY_LEAD_FINAL_ACCEPTANCE_REQUESTED: 'PROPERTY_LEAD_FINAL_ACCEPTANCE_REQUESTED',
  PROPERTY_LEAD_OWNER_FINAL_ACCEPTED: 'PROPERTY_LEAD_OWNER_FINAL_ACCEPTED',
  PROPERTY_LEAD_FINALIZATION_UPDATED: 'PROPERTY_LEAD_FINALIZATION_UPDATED',
  PROPERTY_LEAD_CONVERTED_TO_PROPERTY: 'PROPERTY_LEAD_CONVERTED_TO_PROPERTY',
